...
function resetForm() {
  ...
  var element_evenementiel = document.getElementsByClassName(
    "element_evenementiel"
  );
    ...
    if (radioButton[i].checked) {
      ...
      if ((radioButton[i].value = "Etudiant")) {
        ...
        stringResume +=
          "M/Mme " +
          nom +
          " est patron(ne) et la valeur de la liste est : " +
          document.getElementById("listePatron").value +
          ". ";
      } else {
        // Sinon on met la fonction qui est spécifiée (cadre ou fonctionnaire)
        stringResume +=
          "M/Mme " + nom + " est " + radioButton[i].value.toLowerCase() + ". ";
      }
    }
  }
